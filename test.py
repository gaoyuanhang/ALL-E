...
TRAINING_DATA_PATH          = "./eval15/label.txt"
TESTING_DATA_PATH           = "./eval15/label.txt"
IMAGE_DIR_PATH              = "./eval15/low/"
SAVE_PATH            = "./llemodel/fpop_myfcn_"
...
def test(loader1, agent_el, agent_de, fout, model):
...
def main(fout):
    ...
    pixelwise_a3c_el.chainer.serializers.load_npz('./llemodel/fpop_myfcn_1/model.npz', agent_el.model)
    ...
    test(mini_batch_loader, agent_el, agent_de, fout, model)
